...
class VIT(nn.Module):
    def __init__(self, num_class=None, cfg=None):
        super(VIT, self).__init__()
        self.base = vit_base_patch16_224_TransReID((384, 128)) 
        self.base.load_param('/home/lh/project/TTIPS/weights/jx_vit_base_p16_224-80ecf9dd.pth')
