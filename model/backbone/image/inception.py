...
def inception_iccv(pretrained=False, debug=False, num_classes=51,cfg=None, **kwargs):
    ...
    """
    if pretrained:
        pretrained_dict = torch.load('/home/lh/project/TTIPS/bn_inception-52deb4733.pth')
...
class InceptionNet(nn.Module):
    def __init__(self, num_classes=51, cfg=None):
    ...
    def forward(self, input):
        ...
        print(feat_3b.shape, feat_4d.shape, feat_5b.shape)

        main_feat = self.global_pool(feat_5b).view(bs,-1)
        main_pred = self.finalfc(main_feat)
        print(main_feat.shape, main_pred.shape)
        c
        # main_pred = self.finalfc(main_feat)
        ...
        print(fusion_3b.shape, fusion_4d.shape, fusion_5b.shape)
        pred_3b = self.st_3b(fusion_3b)
        pred_4d = self.st_4d(fusion_4d)
        pred_5b = self.st_5b(fusion_5b)

        print(pred_3b.shape,pred_4d.shape,pred_5b.shape)
        x
        return pred_3b, pred_4d, pred_5b
