...
class ResNet50_sc(nn.Module):
    def __init__(self, num_class, cfg):
        super(ResNet50_sc, self).__init__()
    ...
    def forward(self, x):
        ...
        print('img_embeds_2048.shape', img_embeds_2048.shape)
        N,C,H,W = img_embeds_2048.shape
        h1_img_embeds_2048 = img_embeds_2048[:,:,:H/4,:]
        print('h1_img_embeds_2048', h1_img_embeds_2048.shape)
        c
